        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("1. We have three lives, each mistake we make will lose 1 life and when we lose all (0) we will lose.",style: TextStyle(fontSize: 14),textAlign: TextAlign.left,),
              Text("2. By pressing the button like the one above, spell the word, we can press it as many times as we want.",style: TextStyle(fontSize: 14),textAlign: TextAlign.left,),
              SizedBox(height: 22,),
              Row(
